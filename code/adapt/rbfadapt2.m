% [A,b,E] = rbfadapt2(X,Y,f,A,b,l,tol) Adaptation of an RBF predictive mapping for F
%
...
function [Ab,E] = rbfadapt2(X,Y,f,Ab,l,tol) % for fcn F
...
[tmp1,tmp2,H0] = Ferr_rbf2(Ab',f,X,Y,l); % Initial Hessian estimate
[tmp1,tmp2] = Obfgs2(@Ferr_rbf2,{f,X,Y,l},Ab,tol,[],[]);
Ab = tmp1(end,:);
E = tmp2(end);
