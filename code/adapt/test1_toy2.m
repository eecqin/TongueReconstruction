...
% Centre and scale dataset
XXX = Y2(:,[1:2:end-1]); YYY = Y2(:,[2:2:end]);
[UUU,VVV,mmm] = pca([XXX(:) YYY(:)],2);
Y2 = (Y2-repmat(mmm,size(Y2,1),P))./repmat(sqrt(VVV'),size(Y2,1),P);
X2 = Y2(:,[3 4 7 8 11 12]);
...
tic; [A,b] = rbfadapt(X2,Y2,f,A0,b0,l,1e-2); toc; 
